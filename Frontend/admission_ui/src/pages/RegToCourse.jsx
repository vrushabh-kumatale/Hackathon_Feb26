...
const RegistrationForm = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // ⭐ filter login student
      const loggedStudent = studentRes.data.find(
        s => s.id == studentId
      );

      setStudents([loggedStudent]);
          ...
          <form onSubmit={handleSubmit}>
            ...
            {calculation && (
              ...
              <div className="alert alert-info mt-3">
                ...
                <p>
                  <strong>Original Fee:</strong> ₹{calculation.original_fee}
                </p>

                <p>
                  <strong>Discount:</strong> ₹{calculation.discount_amount}
                </p>
